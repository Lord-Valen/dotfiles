...
- [[#functions][Functions]]
  ...
  - [[#substitute-filenames][substitute-filenames]]
...
#+begin_src emacs-lisp :tangle yes
(defun mine/substitute-filenames (filenames)
  (--map (substitute-in-file-name it) filenames))
#+end_src
* Name and Email
#+begin_src emacs-lisp :tangle yes
...
(use-package! elfeed-org
  :config
  (setq rmh-elfeed-org-files (mine/substitute-filenames (list "$XDG_CONFIG_HOME/doom/elfeed.org"))
